...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white border-b border-ayush-border/80 shadow-2xs">
      ...
      <div className="bg-ayush-primary-dark text-white text-[11px] font-medium tracking-wide py-1.5 px-4 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          {!isPatientArea ? (
            ...
            <div className="hidden md:flex items-center gap-2 bg-ayush-surface px-4 py-1.5 rounded-full border border-ayush-border">
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
              <span className="text-xs font-bold text-ayush-primary">
                Kiosk Terminal AYUSH-04 • Self-Service Mode
              </span>
            </div>
          )}
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Mobile menu trigger (hidden in kiosk mode for minimal distractions) */}
            {!isPatientArea && (
              <button
                type="button"
